...
func findOptimal(_ keystrokes:Int)->Int{
    ...
    var screen = Array(repeating: 0, count: keystrokes + 1)
    ...
    for n in 7..<(keystrokes + 1) {
        ...
        // n-3 means Ctrl A, Ctrl C, Ctrl V, doubles the ouput
        // n-4 means Ctrl A, Ctrl C, Ctrl V, Ctrl V, triples the output
        // n-5 means Ctrl A, Ctrl C, Ctrl V, Ctrl V, Ctrl V, quadruples the output
        ...
        // 4. Maybe another option 5 * screen[n - 6], think why not necessary?
